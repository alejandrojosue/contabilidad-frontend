import { N as NOOP_MIDDLEWARE_HEADER, R as REDIRECT_STATUS_CODES, A as AstroError, h as ActionsReturnedInvalidDataError, D as DEFAULT_404_COMPONENT } from './astro/server_BXAL7MSl.mjs';
...
const __vite_import_meta_env__ = {"ASSETS_PREFIX": undefined, "BASE_URL": "/", "DEV": false, "MODE": "production", "PROD": true, "PUBLIC_COMPANY_NAME": "Cámara de Comercio e Industria de La Paz", "PUBLIC_STRAPI_HOST": "http://localhost:8080/api", "PUBLIC_STRAPI_HOST_BASE": "http://localhost:8080", "SITE": undefined, "SSR": true};
